...
def updateGame(action):
  ...
  # If the key pressed is J, the initial speed in X and Y is calculated and the control variable fire is set to True    if action == 6:
        vx = vel * cos(rads)

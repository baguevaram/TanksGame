...
for e in range(episodes):
    ...
    while not win:
        ...
        for event in pygame.event.get():  # Les vnements qui se produisent dans le jeu sont pass�s en revue
             # Si l'�v�nement est de quitter la fentre, la boucle est rompue
